...
public class Conan {
    ...
    public static class ConanResult {
        public String format;
        public String decoded;
        public boolean isEncoded;

        public ConanResult(String format, String decoded, boolean isEncoded) {
            this.format = format;
    ...
    public static ConanResult automatic_detective(String input) {
        if (input == null) return new ConanResult("Unknown", input, false);
        String decoded = "";
        String lastFormat = "";
        ...
        while (true) {
            ...
            if (match == null) {
                ...
                return new ConanResult("Plain input", currentInput, !lastFormat.isEmpty());
            }
            ...
            switch (match) {
                ...
                default:
                    ...
                    return new ConanResult("Plain input", null, false);
            }

            if (decoded == null) return new ConanResult("Plain input", currentInput, false);
            lastFormat = match;
